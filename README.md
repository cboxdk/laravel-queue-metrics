# This is my package laravel-queue-metrics
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-queue-metrics.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-queue-metrics)
...
```bash
php artisan vendor:publish --tag="laravel-queue-metrics-views"
```

## Usage

```php
$laravelQueueMetrics = new PHPeek\LaravelQueueMetrics();
echo $laravelQueueMetrics->echoPhrase('Hello, PHPeek!');
```
